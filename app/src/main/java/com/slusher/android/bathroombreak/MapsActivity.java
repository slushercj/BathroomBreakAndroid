...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private final int MY_PERMISSION_ACCESS_LOCATION = 1;
                ...
                public void onSuccess(Location location) {
                    if (location != null) {
                        ...
                        mMap.addMarker(new MarkerOptions()
                                ...
                                .title("Marker for current location"));
            ...
            mFusedLocationProviderClient.getLastLocation().addOnSuccessListener(this, new OnSuccessListener<Location>() {
                ...
                public void onSuccess(Location location) {
                    if (location != null) {
                        ...
                        mMap.addMarker(new MarkerOptions().position(currentLocation).title("Marker for current location"));
//                        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(currentLocation, 11.0f));
                        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(currentLocation, 11.0f));
                    }
                }
